...
function Appeal() {
    ...
    return (
        <div className="bg-[#121214]/80 backdrop-blur-sm border border-[#cd41ff]/20 rounded-xl p-8 my-12 text-center max-w-3xl mx-auto shadow-lg shadow-[#cd41ff]/10" aria-label="Appeal Discord ban">
            <h3 className="text-3xl font-bold mb-4 bg-gradient-to-r from-[#cd41ff] to-purple-400 bg-clip-text text-transparent">{title}</h3>
